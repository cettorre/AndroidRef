...
public class Location10Activity extends AppCompatActivity implements
        LocationListener, GoogleApiClient.ConnectionCallbacks {

    private static final String TAG = "AndroidRef";
    ...
    public void onPause() {
        ...
        if (mApiClient.isConnected()) {
            LocationServices.FusedLocationApi
                    .removeLocationUpdates(mApiClient, (com.google.android.gms.location.LocationListener) this);
        }
        //Detach from Play Services
        mApiClient.disconnect();
    }

    //get Current Location throuhg Location class
